          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {navItems.map((item) => (
                  <li key={item.href}>
                    <a href={item.href} className="text-sm text-gray-500 hover:text-white transition-colors duration-300">
                      {item.label}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" className="text-sm text-gray-500 hover:text-[#0088cc] transition-colors duration-300 flex items-center gap-2">
                ...
                <li>
                  <a href="#" className="text-sm text-gray-500 hover:text-white transition-colors duration-300 flex items-center gap-2">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
