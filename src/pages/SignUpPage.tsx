...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#08061a] flex items-center justify-center px-4">
      {/* 배경 글로우 */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-purple-900/20 blur-[70px] rounded-full pointer-events-none" />
          ...
          {step === "form" && (
            <>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs text-gray-600">또는 이메일로 가입</span>
                <div className="flex-1 h-px bg-gray-700/50" />
              </div>
